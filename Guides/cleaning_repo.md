...
1. #### Suppose your directory has a file ```main.cpp```. On compiling the code, it generates an ```a.out``` file. 

2. #### On doing ```git status```, you will notice that ```a.out``` is one of the untracked files. (as we have not commited it yet)

<p align="center">
<img src="https://user-images.githubusercontent.com/38832512/96430171-761f9700-121f-11eb-930a-5f6e3f2ee6d0.png">
</p>

3. #### To ignore the ```.out``` file, create a ```.gitignore``` file and add *.out. This tells it to ignore all files of the extension .out

### This is what the gitignore file looks like

<p align="center">
<img src="https://user-images.githubusercontent.com/38832512/96432369-68b7dc00-1222-11eb-9319-84ff603264b7.png">
</p>

4. #### After adding the ```.gitignore``` file, this is what the repo status looks like

<p align="center">
<img src="https://user-images.githubusercontent.com/38832512/96430528-e6c6b380-121f-11eb-8118-452ca01458b8.png">
</p>
